...
import styles from "./TicketsBlue.module.scss"

interface TicketsBlueProps {
    naming: string;
    icon: string;
    about1: string;
    about2: string;
...
const TicketsBlue: React.FC<TicketsBlueProps> = ({ naming, icon, about1, about2, about3, price, w, h }) => {
