...
const EmailConfirmation = ({ show, onCloseButtonClick}) => {
    ...
    return(
        <div className={styles['recover']}>
            <div className={styles['recover-pass']}>
                <PassRecoverText className={styles['recover-pass__text']} title={"ВОССТАНОВИТЬ ПАРОЛЬ"} subtitle={"Код на подтверждение был отправлен на почту asd*****@gmail.com"}/>
                <form onSubmit={handleSubmit(onSubmit)} className={styles['recover-pass__code']}>
                    ...
                    <div className= {styles['recover-pass__code__cancel']} onClick={() => {navigate(-1)}}>
